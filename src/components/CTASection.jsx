...
export default function CTASection({ sectionRef }) {
  ...
  return (
    <section
      ...
      style={{ backgroundColor: '#ffffff', color: '#040720' }}
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
        ...
        <div>
          ...
          >
            ...
            <h2 className="text-[#040720] font-light leading-tight" style={{ fontSize: 'clamp(2rem, 4vw, 3rem)' }}>
              Talk to EDRISYNC
              <br />
          ...
          >
              ...
              <a
                ...
                style={{ color: '#040720', border: '1.5px solid rgba(4,7,32,0.28)' }}
        ...
        >
          {sent ? (
            <div className="text-center py-10">
              ...
              <h3 className="text-xl font-bold" style={{ color: '#040720' }}>Request received!</h3>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full border border-gray-200 text-[#040720] text-sm pl-11 pr-4 py-3 rounded-xl outline-none transition-colors placeholder-gray-400 focus:border-[#B1B6CE]"
                    />
                  </div>
                  <div className="relative">
                ...
                <div className="relative">
                  ...
                  <select
                    ...
                    className="w-full border border-gray-200 text-[#040720] text-sm pl-11 pr-4 py-3 rounded-xl outline-none transition-colors appearance-none placeholder-gray-400 focus:border-[#B1B6CE]"
                  >
                ...
                <div className="relative">
                  ...
                  <textarea
                    ...
                    className="w-full border border-gray-200 text-[#040720] text-sm pl-11 pr-4 py-3 rounded-xl outline-none transition-colors resize-none placeholder-gray-400 focus:border-[#B1B6CE]"
                  />
                </div>
