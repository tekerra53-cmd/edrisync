...
const featuredMembers = [
  { name: 'Arman H. Siddik', role: 'Cloud Engineer', bio: 'Architects resilient cloud infrastructure and migration paths that keep distributed teams fast, secure, and always available.', image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=500&q=80', accent: 'linear-gradient(135deg, #1053F3, #007dc1)' },
  { name: 'Nusrat T. Rahman', role: 'Cybersecurity Lead', bio: 'Designs defense-in-depth strategies and runs 24/7 monitoring to keep client data protected against evolving threats.', image: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&w=500&q=80', accent: 'linear-gradient(135deg, #153b7d, #007dc1)' },
];
...
export default function AboutPage({ onHome }) {
  return (
    <div style={{ backgroundColor: '#ffffff' }} className="min-h-screen">
      {/* HERO */}
      <header className="relative overflow-hidden bg-[#f6f8fc] px-6 pb-24 pt-32 lg:pb-32">
        <div className="absolute inset-0 pointer-events-none" style={{ background: 'radial-gradient(60% 50% at 50% -10%, rgba(16,83,243,0.18), transparent 55%)' }} />
        <div className="relative mx-auto grid max-w-6xl grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-20">
          <div className="text-center lg:text-left">
            <motion.p
              ...
              className="mb-6 text-[10px] font-semibold uppercase tracking-[0.3em] text-[#007dc1]"
            >
              About EdriSync
            </motion.p>
            <motion.h1
              ...
              className="text-4xl font-light leading-[1.08] text-[#061153] sm:text-5xl lg:text-[4.25rem]"
            >
              Technology that makes progress feel <span className="text-[#007dc1]">possible.</span>
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 16 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6, delay: 0.12 }}
              className="mx-auto mt-7 max-w-lg text-[15px] leading-7 text-slate-600 lg:mx-0"
            >
            ...
            >
              <div className="flex -space-x-3">
                <div className="h-10 w-10 rounded-full border-2 border-[#f6f8fc] bg-[#153b7d]" />
                <div className="h-10 w-10 rounded-full border-2 border-[#f6f8fc] bg-[#007dc1]" />
              </div>
              <p className="text-left text-xs leading-5 text-slate-500"><span className="font-semibold text-[#061153]">15+ years</span><br />building digital confidence</p>
            </motion.div>
          </div>
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="overflow-hidden rounded-[1.75rem] bg-white p-3 shadow-[0_24px_60px_rgba(6,17,83,0.14)]">
            ...
            <div className="absolute -bottom-8 -left-5 w-44 overflow-hidden rounded-2xl border-4 border-[#f6f8fc] bg-white p-1 shadow-[0_16px_35px_rgba(6,17,83,0.16)] sm:-left-10 sm:w-52">
              <img src={IMG_TEAM} alt="Team collaborating" className="h-28 w-full rounded-xl object-cover sm:h-36" draggable={false} />
            </div>
            <div className="absolute right-5 top-5 rounded-xl bg-[#153b7d] px-4 py-3 text-white shadow-lg">
              <p className="text-xl font-light">2011</p>
              <p className="mt-1 text-[9px] uppercase tracking-[0.18em] text-[#bfe6ff]">Established</p>
            </div>
          </motion.div>
        </div>
      </header>
      ...
      <section className="relative py-24 px-6 bg-white overflow-hidden">
        <div className="absolute inset-0 pointer-events-none" style={{ background: 'radial-gradient(55% 45% at 100% 0%, rgba(16,83,243,0.07), transparent 50%)' }} />
        <div className="relative max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          >
            ...
            <blockquote className="text-2xl lg:text-[2.35rem] font-light leading-[1.15]" style={{ color: '#061153' }}>
            ...
            <div className="flex items-center gap-5 mt-8">
              <div className="text-4xl font-light" style={{ color: '#061153' }}>15<span className="text-[#007dc1]">+</span></div>
              <div>
                <p className="text-sm font-medium text-[#061153]">Years building</p>
          ...
          >
            <div className="rounded-[1.5rem] overflow-hidden" style={{ height: '260px', boxShadow: '0 20px 48px rgba(6,17,83,0.16)' }}>
            ...
            <div className="rounded-[1.5rem] overflow-hidden mt-10" style={{ height: '260px', boxShadow: '0 20px 48px rgba(6,17,83,0.16)' }}>
      ...
      <section className="relative overflow-hidden py-24 px-6" style={{ backgroundColor: '#f6f8fc' }}>
        <div className="absolute inset-0 pointer-events-none" style={{ background: 'radial-gradient(55% 45% at 50% 0%, rgba(16,83,243,0.1), transparent 55%)' }} />
        <div className="relative max-w-6xl mx-auto">
          <div className="mb-14 max-w-xl">
            <p className="text-xs uppercase tracking-[0.3em] font-medium" style={{ color: '#007dc1' }}>The EdriSync way</p>
            <h2 className="mt-3 text-3xl lg:text-4xl font-light leading-tight" style={{ color: '#061153' }}>Clear thinking. Practical delivery. Lasting confidence.</h2>
          </div>
          ...
          {purposes.map((p, i) => {
            ...
            return (
              <motion.div
                ...
                style={{ border: '1px solid rgba(6,17,83,0.07)', boxShadow: '0 12px 30px rgba(6,17,83,0.04)' }}
                whileHover={{ y: -6 }}
                onMouseEnter={(e) => { e.currentTarget.style.boxShadow = '0 22px 48px rgba(16,83,243,0.12)'; e.currentTarget.style.borderColor = 'rgba(16,83,243,0.18)'; }}
                onMouseLeave={(e) => { e.currentTarget.style.boxShadow = '0 12px 30px rgba(6,17,83,0.04)'; e.currentTarget.style.borderColor = 'rgba(6,17,83,0.07)'; }}
              >
                ...
                <div className="w-12 h-12 rounded-2xl flex items-center justify-center mb-6 transition-transform duration-300 group-hover:scale-110" style={{ background: 'linear-gradient(135deg, #1053F3, #007dc1)' }}>
            ...
            {values.map((value, i) => {
              ...
              return (
                <motion.div
                  ...
                  whileHover={{ y: -6 }}
                  className="group rounded-[1.5rem] p-7 transition-all duration-300"
                  style={{ background: '#fff', border: '1px solid rgba(6,17,83,0.07)', boxShadow: '0 8px 30px rgba(6,17,83,0.05)' }}
                  onMouseEnter={(e) => { e.currentTarget.style.boxShadow = '0 22px 46px rgba(16,83,243,0.16)'; e.currentTarget.style.borderColor = 'rgba(16,83,243,0.22)'; }}
                ...
                >
                  ...
                  <h4 className="font-semibold text-lg mb-2" style={{ color: '#061153' }}>{value.title}</h4>
        ...
        <div className="mx-auto max-w-6xl">
          ...
          >
            <div className="max-w-2xl">
              <p className="text-xs font-medium uppercase tracking-[0.3em]" style={{ color: '#007dc1' }}>What we do</p>
              <h2 className="mt-3 text-3xl font-light text-[#061153] lg:text-4xl">
            ...
            {capabilities.map((cap, i) => {
              ...
              return (
                <motion.div
                  ...
                  style={{
                    background: isFeatured ? 'var(--edri-nav-blue)' : '#f6f8fc',
                    border: isFeatured ? 'none' : '1px solid rgba(6,17,83,0.07)',
                    boxShadow: isFeatured ? '0 18px 42px rgba(21,59,125,0.18)' : 'none',
                  }}
                  onMouseEnter={(e) => { if (!isFeatured) { e.currentTarget.style.boxShadow = '0 14px 38px rgba(6,17,83,0.1)'; e.currentTarget.style.borderColor = 'rgba(16,83,243,0.18)'; } }}
                  onMouseLeave={(e) => { if (!isFeatured) { e.currentTarget.style.boxShadow = 'none'; e.currentTarget.style.borderColor = 'rgba(6,17,83,0.07)'; } }}
                >
                  ...
                  <div className="relative z-10 flex h-full flex-col justify-between">
                    <div>
                      <div className="mb-6 flex h-12 w-12 items-center justify-center rounded-xl" style={{ background: isFeatured ? 'rgba(255,255,255,0.14)' : 'linear-gradient(135deg, #1053F3, #007dc1)' }}>
                        <Icon className="h-6 w-6 text-white" />
                      </div>
                      <h4 className={`mb-2 text-xl font-semibold ${isFeatured ? 'text-white' : 'text-[#061153]'}`}>{cap.title}</h4>
                      <p className={`max-w-xl text-sm leading-6 ${isFeatured ? 'text-blue-100' : 'text-slate-600'}`}>{cap.desc}</p>
                    </div>
                    {isFeatured && <span className="mt-8 text-[10px] font-semibold uppercase tracking-[0.24em] text-[#bfe6ff]">Core capability</span>}
                  </div>
                </motion.div>
              );
            })}
      ...
      <section className="relative py-24 px-6 overflow-hidden" style={{ backgroundColor: '#f6f8fc' }}>
        <div className="absolute inset-0 pointer-events-none" style={{ background: 'radial-gradient(55% 45% at 50% 0%, rgba(16,83,243,0.1), transparent 55%)' }} />
        <div className="relative max-w-6xl mx-auto">
          <motion.div
            initial={{ opacity: 0, y: 16 }}
          ...
          <div className="flex gap-5 overflow-x-auto pb-4 snap-x" style={{ scrollbarWidth: 'thin' }}>
            {milestones.map((m, i) => (
              <motion.div
                ...
                style={{ border: '1px solid rgba(6,17,83,0.07)', boxShadow: '0 14px 34px rgba(6,17,83,0.06)' }}
                onMouseEnter={(e) => { e.currentTarget.style.boxShadow = '0 22px 46px rgba(16,83,243,0.14)'; e.currentTarget.style.borderColor = 'rgba(16,83,243,0.18)'; }}
                onMouseLeave={(e) => { e.currentTarget.style.boxShadow = '0 14px 34px rgba(6,17,83,0.06)'; e.currentTarget.style.borderColor = 'rgba(6,17,83,0.07)'; }}
              >
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-semibold mb-5" style={{ background: 'rgba(0,125,193,0.12)', color: '#007dc1' }}>{m.year}</div>
      ...
      {/* TEAM */}
      <section className="relative py-24 px-6 overflow-hidden" style={{ backgroundColor: '#f6f8fc' }}>
        <div className="absolute inset-0 pointer-events-none" style={{ background: 'radial-gradient(55% 45% at 50% -5%, rgba(16,83,243,0.12), transparent 60%)' }} />
        <div className="relative max-w-6xl mx-auto">
          <motion.div
            initial={{ opacity: 0, y: 16 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-2 mb-6">
            {featuredMembers.map((member, i) => (
              <motion.div
                ...
                style={{ border: '1px solid rgba(6,17,83,0.08)', boxShadow: '0 10px 28px rgba(6,17,83,0.06)' }}
                onMouseEnter={(e) => { e.currentTarget.style.boxShadow = '0 22px 46px rgba(16,83,243,0.16)'; e.currentTarget.style.borderColor = 'rgba(16,83,243,0.22)'; }}
                onMouseLeave={(e) => { e.currentTarget.style.boxShadow = '0 10px 28px rgba(6,17,83,0.06)'; e.currentTarget.style.borderColor = 'rgba(6,17,83,0.08)'; }}
              >
                <div className="grid grid-cols-1 sm:grid-cols-[220px_1fr]">
                  <div className="relative h-64 sm:h-auto overflow-hidden bg-[#e9eef7]">
                    <img
                      src={member.image}
                      alt={member.name}
                    ...
                    <div
                      ...
                      style={{ background: 'linear-gradient(180deg, transparent 50%, rgba(6,17,83,0.35))' }}
                    />
                  ...
                  <div className="p-7 sm:p-8 flex flex-col justify-center">
                    <div className="hidden sm:block">
                      <h3 className="text-xl font-semibold" style={{ color: '#061153' }}>{member.name}</h3>
                      <p className="mt-1 text-xs font-semibold uppercase tracking-[0.12em]" style={{ color: '#007dc1' }}>{member.role}</p>
                      <div className="mt-4 h-px w-10" style={{ background: 'linear-gradient(90deg, #1053F3, #007dc1)' }} />
                    </div>
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {teamMembers.slice(0, 3).map((member, i) => (
              <motion.div
                ...
                onMouseEnter={(e) => { e.currentTarget.style.boxShadow = '0 18px 38px rgba(16,83,243,0.14)'; e.currentTarget.style.borderColor = 'rgba(16,83,243,0.22)'; }}
                onMouseLeave={(e) => { e.currentTarget.style.boxShadow = '0 8px 24px rgba(6,17,83,0.05)'; e.currentTarget.style.borderColor = 'rgba(6,17,83,0.08)'; }}
              >
                <div className="relative h-64 overflow-hidden bg-[#e9eef7]">
                  <img
                    src={member.image}
                    alt={member.name}
                  ...
                  <div
                    className="absolute inset-0"
                    style={{ background: 'linear-gradient(180deg, transparent 55%, rgba(6,17,83,0.32))' }}
                  />
                </div>
                <div className="p-7">
                  <h3 className="text-base font-semibold" style={{ color: '#061153' }}>{member.name}</h3>
                  <p className="mt-1 text-xs font-semibold uppercase tracking-[0.12em]" style={{ color: '#007dc1' }}>{member.role}</p>
                  <div className="my-4 h-px w-8" style={{ background: 'linear-gradient(90deg, #1053F3, #007dc1)' }} />
