...
function OrbitVisual({ service }) {
  ...
  return (
    <div className="relative mx-auto aspect-square w-full max-w-[510px]">
      ...
      />
      <div className="absolute inset-[5%] rounded-full bg-[#040720]/40 blur-3xl" />
      <motion.div
        className="absolute left-1/2 top-1/2 flex h-[42%] w-[42%] -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-[30%] border border-white/30 bg-[#040720]/90 shadow-[0_0_70px_rgba(255,255,255,0.22)] backdrop-blur-xl"
        animate={{ scale: [1, 1.04, 1], rotate: [0, 2, 0] }}
        transition={{ duration: 5, repeat: Infinity, ease: 'easeInOut' }}
      >
        <div className="flex h-[72%] w-[72%] flex-col items-center justify-center rounded-[24%] border border-white/10 bg-[#040720]/90">
      ...
      <motion.div
        className="absolute left-[7%] top-[20%] flex items-center gap-2 rounded-full border border-white/15 bg-[#040720]/90 px-3 py-2 text-[10px] text-white/80 shadow-lg backdrop-blur-md"
        animate={{ y: [0, -8, 0] }}
      ...
      <motion.div
        className="absolute bottom-[18%] right-[4%] flex items-center gap-2 rounded-full border border-white/15 bg-[#040720]/90 px-3 py-2 text-[10px] text-white/80 shadow-lg backdrop-blur-md"
        animate={{ y: [0, 8, 0] }}
...
function CybersecurityLayout({ service, onServices, onHome }) {
  const Icon = service.icon;
  return (
    <div className="min-h-screen bg-[#f7f9fd] text-[#040720]">
      <header className="relative overflow-hidden bg-[linear-gradient(135deg,#087fd1_0%,#4da8ef_100%)] px-6 pb-20 pt-32 lg:pb-28">
        ...
        <div className="relative mx-auto max-w-7xl">
          <button onClick={onServices} className="mb-10 inline-flex items-center gap-2 text-sm text-[#040720]/85 transition-colors hover:text-[#040720]">
            <ArrowLeft className="h-4 w-4" /> All services
          </button>
          <div className="grid items-center gap-14 lg:grid-cols-[0.92fr_1.08fr] lg:gap-20">
            <motion.div initial={{ opacity: 0, x: -24 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.7 }}>
              <div className="mb-5 flex items-center gap-3 text-xs font-medium uppercase tracking-[0.28em] text-[#040720]">
      ...
      <main id="service-start">
        <section className="mx-auto grid max-w-7xl gap-12 px-6 py-20 lg:grid-cols-[0.8fr_1.2fr] lg:items-center lg:py-28">
          ...
          <motion.div initial={{ opacity: 0, x: 24 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="relative overflow-hidden rounded-[28px] bg-[#040720] shadow-[0_24px_70px_rgba(4,7,32,0.18)]">
            <img src={service.image} alt={`${service.eyebrow} in practice`} className="h-[340px] w-full object-cover opacity-70 mix-blend-screen" />
            <div className="absolute inset-0 bg-gradient-to-tr from-[#040720] via-[#040720]/30 to-transparent" />
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {service.capabilities.map((capability, index) => (
                <motion.div key={capability} initial={{ opacity: 0, y: 14 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: index * 0.06 }} className="group relative min-h-[168px] overflow-hidden rounded-2xl border border-slate-200 bg-[#ffffff] p-6 transition-colors hover:border-[#B1B6CE]">
                  ...
                  <div className="absolute inset-0 bg-[#040720]/90 opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
                  ...
                  <h3 className="relative z-10 font-semibold text-[#040720] transition-colors duration-300 group-hover:text-white">{capability}</h3>
                </motion.div>
              ))}
            </div>
          </div>
        ...
        <section className="bg-[linear-gradient(135deg,#087fd1_0%,#4da8ef_100%)] px-6 py-20 text-white lg:py-24">
...
function GRCLayout({ service, onServices, onHome }) {
  return (
    <div className="min-h-screen bg-white text-[#040720]">
